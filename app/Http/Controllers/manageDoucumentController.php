...
class manageDoucumentController extends Controller
{
    ...
    public function invoiceDollar(Request $request)
    {
        ...
        $myFileToJson = fopen('C:\laragon\www\cottonandmore\EInvoicing\SourceDocumentJson.json', 'w') or die('unable to open file');
    ...
    public function draftDollar(Request $request)
    {
        ...
        $myFileToJson = fopen('C:\laragon\www\cottonandmore\EInvoicing\SourceDocumentJson.json', 'w') or die('unable to open file');
        fwrite($myFileToJson, $trnsformed);
        $path = 'C:\laragon\www\cottonandmore\EInvoicing\SourceDocumentJson.json';
    ...
    public function searchInSentInv(Request $request)
    {
        ...
        // ]);
        // $token = $response['access_token'];
        return view('sentofdraft.index', compact(
            'allSent',
        ));
    }
    ...
    {
        shell_exec('C:\laragon\www\cottonandmore\EInvoicing/SubmitInvoices2.bat');
        $path = 'C:\laragon\www\cottonandmore\EInvoicing/FullSignedDocument.json';
        $path2 = 'C:\laragon\www\cottonandmore\EInvoicing/Cades.txt';
        $path3 = 'C:\laragon\www\cottonandmore\EInvoicing/CanonicalString.txt';
        $path4 = 'C:\laragon\www\cottonandmore\EInvoicing/SourceDocumentJson.json';
    ...
    public function createInvoice2(Request $request)
    {
        ...
        return view('invoices.createInvoice2', compact('companiess', 'allCompanies', 'ActivityCodes', 'taxTypes'));
    }
    ...
    public function createInvoiceDollar()
    {
        ...
        $unittypes = DB::table('unittypes')->get();
        $taxTypes = DB::table('taxtypes')->get();
        return view('invoices.createInvoice3', compact('allCompanies', 'ActivityCodes', 'taxTypes', 'products', 'unittypes'));
    }
    ...
    public function createInvoiceDollar2(Request $request)
    {
        ...
        $taxTypes = DB::table('taxtypes')->get();
        $companiess = DB::table('companies2')->where('id', $request->receiverName)->get();
        return view('invoices.createInvoice3', compact('companiess', 'allCompanies', 'ActivityCodes', 'taxTypes'));
    }
    ...
    public function createInvoice3()
    {
        ...
        $allCompanies = DB::table('companies2')->get();
        $taxTypes = DB::table('taxtypes')->get();
        return view('invoices.createInvoice3', compact('allCompanies', 'ActivityCodes', 'taxTypes', 'products'));
    }
