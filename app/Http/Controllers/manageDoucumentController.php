...
// this is for create page of invoice
    public function createInvoice()
    {
        ...
        return view('invoices.createInvoice2', compact('allCompanies', 'codes', 'ActivityCodes', 'taxTypes', 'unittypes'));
    }
    ...
    public function createInvoiceDollar2(Request $request)
    {
        ...
        $taxTypes = DB::table('taxtypes')->get();
        $companiess = DB::table('companies2')->where('id', $request->receiverName)->get();
        return view('invoices.createInvoice3', compact('companiess', 'allCompanies', "codes", 'ActivityCodes', 'taxTypes'));
    }
